...
import tasks.Wait;
import tasks.VRSuperClass.ExtentManager;
import tasks.VerifyURL;
public class portal extends VRSuperClass {
                    ...
                    test = report.createTest(TestScenarioId);
                            try {
                                for (Iterator<Integer> iter = TaskList.keySet().iterator(); iter.hasNext();) {
                                                ...
                                                //String screenCapture = logger.addScreenCapture(library.CaptureScreenshot.getScreen(driver,"PAP"));
                                                //logger.log(LogStatus.PASS, "finished PAP", screenCapture);
                                }
                                ...
                                //logger.log(LogStatus.PASS, "test case completed");
                               }
                              ...
                              catch (Exception e)
                               {
                            	  ...
                            	  CaptureScreenshot sc = new CaptureScreenshot();
                        			...
                        			test.fail("Test Case Failed",
                      					MediaEntityBuilder.createScreenCaptureFromPath(screenshotPath).build());     //String screenCapture = logger.addScreenCapture(library.CaptureScreenshot.getScreen(driver,"Exception"));
                                         //logger.log(LogStatus.FAIL, "caught exception", screenCapture);
                            }                
