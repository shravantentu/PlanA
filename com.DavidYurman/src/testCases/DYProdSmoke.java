...
import tasks.Wait;
import tasks.isEnabled;
import tasks.VerifyProductcount;
//import testCases.DriverScript.ExtentManager;
public class DYProdSmoke extends VRSuperClass {

                public void DyProdCheck() throws Exception {
                                ...
                                for (Iterator<Integer> iter = TaskList.keySet().iterator(); iter.hasNext();) {
                                                ...
                                                case NAVIGATE_URL: {
                                                                resultsLog.info("Calling NAVIGATE_URL");
                                                ...
                                                case IS_ENABLED: {
                                                    resultsLog.info("Calling GetText Task from AccessCMS TestCase Script");
                                                    isEnabled isnabled = new isEnabled();
                                                    isnabled.isenabled();
                                                    //logger.log(LogStatus.PASS, "user successfully got text");
                                                    break;
                                                }
                                                case CLEAR_TEXT: {
                                                    resultsLog.info("Verifying element is enabled or not");
                                            	...
                                            	case CLICK_ICON: {
                                    				resultsLog.info("Calling CLICK_ICON");
